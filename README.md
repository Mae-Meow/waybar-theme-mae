...
<img width="2553" height="56" alt="image" src="https://github.com/user-attachments/assets/3f2a64d7-b884-41a0-a1ad-edc057a67238" />
...
```bash
git clone https://github.com/Mae-Meow/waybar-theme-mae && cd waybar-theme-mae && chmod +x ./waybar_setup.sh && ./waybar_setup.sh
```
